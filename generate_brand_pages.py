...
<section class="sec on-dark" id="apply-brand" style="background:var(--jamun-deep)">
  <div class="wrap">
    <div style="max-width:720px;margin:0 auto">
      <div class="sec-head wide text-center rv" style="text-align:center;margin-bottom:32px">
        <p class="eyebrow on-dark">Direct Founder Connect</p>
        <h2 style="color:var(--malai)">Apply For {brand_name} Franchise</h2>
        <p class="sec-note on-dark" style="margin:0 auto">Zero brokerage fee. A dedicated Franchise 101 advisor will review your location and coordinate directly with {brand_name} brand directors.</p>
      </div>

      <div style="background:rgba(255,243,222,0.05);border:1px solid rgba(255,243,222,0.15);border-radius:24px;padding:clamp(24px, 4vw, 40px)" class="rv">
        <form class="form" onsubmit="handleBrandApply(event)">
          ...
          <div id="applySuccess" style="display:none;background:rgba(169,232,107,0.15);border:1px solid var(--pista);border-radius:12px;padding:16px;margin:16px 0;color:var(--malai)">
            <strong style="color:var(--pista)">Application Submitted Successfully!</strong>
            <p style="font-size:14px;margin:6px 0 0">Your inquiry for {brand_name} has been routed to our senior team. A dedicated franchise manager will call you with the complete P&amp;L projection within 24 hours.</p>
          </div>
