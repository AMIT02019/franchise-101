...
.capex-table tr.total-row {{ background: rgba(234,179,8,0.1); font-weight: 800; }}
    ...
    <div style="display:grid;grid-template-columns:1.2fr 1fr;gap:clamp(32px, 4vw, 56px);align-items:start">
      ...
      <div>
        ...
        <div class="pnl-card rv">
          ...
          <div class="pnl-row" style="background:rgba(234,179,8,0.15);padding:14px;border-radius:12px;margin-top:10px">
